...
CREATE TABLE `bsd` (
  ...
  `bz` varchar(200) default NULL COMMENT '��ע',
  PRIMARY KEY  (`djid`),
  KEY `userid` (`userid`),
...
CREATE TABLE `bsdsp` (
  ...
  `djid` varchar(14) NOT NULL,
  `spid` varchar(10) NOT NULL COMMENT '��Ʒid',
  `spname` varchar(20) default NULL COMMENT '��Ʒ����',
  `spdw` varchar(20) default NULL COMMENT '��Ʒ��λ',
  `spxinghao` varchar(20) default NULL COMMENT '����ͺ�',
  `dj` double default NULL COMMENT '����',
  `sl` int(11) default NULL COMMENT '����',
  `zj` double default NULL COMMENT '�ܼ�',
  PRIMARY KEY  (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='���絥';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='���絥��Ʒ';
...
CREATE TABLE `ckd` (
  `djid` varchar(14) NOT NULL,
  `khid` int(11) default NULL COMMENT '��Ӧ��id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='���۳���';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='���۵���Ʒ';
...
CREATE TABLE `gys` (
  ...
  `lxren` varchar(30) default NULL COMMENT '��ϵ��',
  `lxtel` varchar(30) default NULL COMMENT '��ϵ�绰',
...
CREATE TABLE `spdw` (
  ...
  PRIMARY KEY  (`dwid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='���ﵥλ';
...
CREATE TABLE `splb` (
  ...
  `lbname` varchar(20) default NULL COMMENT '�������',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='�ͻ��˻���Ʒ';
...
-- Records 
-- ----------------------------
INSERT INTO `menu` VALUES ('0', 'ϵͳ�˵�', '-1', null, '1', '0', 'menu-plugin');
INSERT INTO `menu` VALUES ('10', '��������', '0', null, '1', '1', 'menu-1');
INSERT INTO `menu` VALUES ('20', '���۹���', '0', null, '1', '2', 'menu-2');
INSERT INTO `menu` VALUES ('30', '������', '0', null, '1', '3', 'menu-3');
INSERT INTO `menu` VALUES ('40', 'ͳ�Ʊ���', '0', null, '1', '4', 'menu-4');
INSERT INTO `menu` VALUES ('50', '��������', '0', null, '1', '5', 'menu-5');
INSERT INTO `menu` VALUES ('60', 'ϵͳ����', '0', null, '1', '6', 'menu-6');
INSERT INTO `menu` VALUES ('1010', '�������', '10', '../jinhuo/jinhuo.jsp', '0', '1', 'menu-11');
INSERT INTO `menu` VALUES ('1020', '�˻�����', '10', '../jinhuo/tuihuo.jsp', '0', '2', 'menu-12');
INSERT INTO `menu` VALUES ('1030', '�������ݲ�ѯ', '10', '../jinhuo/jinsearch.jsp', '0', '3', 'menu-13');
INSERT INTO `menu` VALUES ('1040', '�˻����ݲ�ѯ', '10', '../jinhuo/mingxi.jsp', '0', '4', 'menu-14');
INSERT INTO `menu` VALUES ('1050', '��ǰ����ѯ', '10', '../kucun/kcsearch.jsp', '0', '5', 'menu-15');
INSERT INTO `menu` VALUES ('2010', '���۳���', '20', '../chushou/chuku.jsp', '0', '1', 'menu-21');
INSERT INTO `menu` VALUES ('2020', '�ͻ��˻�', '20', '../chushou/tuiku.jsp', '0', '2', 'menu-22');
INSERT INTO `menu` VALUES ('2030', '���۵��ݲ�ѯ', '20', '../chushou/chusearch.jsp', '0', '3', 'menu-23');
INSERT INTO `menu` VALUES ('2040', '�ͻ��˻���ѯ', '20', '../chushou/mingxi.jsp', '0', '4', 'menu-24');
INSERT INTO `menu` VALUES ('2050', '��ǰ����ѯ', '20', '../kucun/kcsearch.jsp', '0', '5', 'menu-25');
INSERT INTO `menu` VALUES ('3010', '��Ʒ����', '30', '../kucun/baosun.jsp', '0', '1', 'menu-31');
INSERT INTO `menu` VALUES ('3020', '��Ʒ����', '30', '../kucun/baoyi.jsp', '0', '2', 'menu-32');
INSERT INTO `menu` VALUES ('3030', '��汨��', '30', '../kucun/baojing.jsp', '0', '3', 'menu-33');
INSERT INTO `menu` VALUES ('3040', '�������ѯ', '30', '../kucun/biansearch.jsp', '0', '4', 'menu-34');
INSERT INTO `menu` VALUES ('3050', '��ǰ����ѯ', '30', '../kucun/kcsearch.jsp', '0', '5', 'menu-35');
INSERT INTO `menu` VALUES ('4010', '��Ӧ��ͳ��', '40', '../tongji/gystj.jsp', '0', '1', 'menu-41');
INSERT INTO `menu` VALUES ('4020', '�ͻ�ͳ��', '40', '../tongji/khtj.jsp', '0', '2', 'menu-42');
INSERT INTO `menu` VALUES ('4030', '��Ʒ�ɹ�ͳ��', '40', '../tongji/spcgtj.jsp', '0', '3', 'menu-43');
INSERT INTO `menu` VALUES ('4040', '��Ʒ����ͳ��', '40', '../tongji/spxstj.jsp', '0', '4', 'menu-44');
INSERT INTO `menu` VALUES ('4050', '����ͳ�Ʒ���', '40', '../tongji/tjfxri.jsp', '0', '5', 'menu-45');
INSERT INTO `menu` VALUES ('4060', '����ͳ�Ʒ���', '40', '../tongji/tjfxyue.jsp', '0', '6', 'menu-46');
INSERT INTO `menu` VALUES ('5010', '��Ӧ�̹���', '50', '../ziliao/gys.jsp', '0', '1', 'menu-51');
INSERT INTO `menu` VALUES ('5020', '�ͻ�����', '50', '../ziliao/kh.jsp', '0', '2', 'menu-52');
INSERT INTO `menu` VALUES ('5030', '��Ʒ����', '50', '../ziliao/spxx.jsp', '0', '3', 'menu-53');
INSERT INTO `menu` VALUES ('5040', '�ڳ����', '50', '../ziliao/kc.jsp', '0', '4', 'menu-54');
INSERT INTO `menu` VALUES ('6010', '��ɫ����', '60', '../power/role.jsp', '0', '1', 'menu-61');
INSERT INTO `menu` VALUES ('6020', '�û�����', '60', '../power/user.jsp', '0', '2', 'menu-62');
INSERT INTO `menu` VALUES ('6030', '���ݿ����', '60', '../power/beifen.jsp', '3', '3', 'menu-63');
INSERT INTO `role` VALUES ('1', '����Ա', 'ϵͳ����');
...
INSERT INTO `spdw` VALUES ('1', '��');
INSERT INTO `spdw` VALUES ('2', '��');
INSERT INTO `spdw` VALUES ('3', '��');
INSERT INTO `spdw` VALUES ('4', '��');
INSERT INTO `users` VALUES ('1', 'admin', 'admin', '����Ա', '1', '0', 'ϵͳ����Ա');
